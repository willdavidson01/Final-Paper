...
abstract: "Toronto has been experiencing a significant rise in homelessness, with a large sum of individuals sleeping in shelters or on the streets each night. The factors contributing to this issue are complex and multifaceted, including high housing costs, inadequate social assistance programs, and mental health and addiction challenges. The COVID-19 pandemic has only exacerbated the problem, with job losses and economic uncertainty leading to more individuals experiencing housing insecurity. Addressing this crisis will require a comprehensive approach that prioritizes affordable housing, social support programs, and mental health and addiction services."
format: pdf
